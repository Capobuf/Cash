...
- Added principles: Verifiable calculations; Explicit data and no fallback; Historical snapshots;
  Native-local security boundary; Atomic persistence and conflict safety
- Added sections: Product boundaries; Delivery quality gates
...
The canonical product scope is `Cash_Specifica_Funzionale_v0.5.md`. Cash is a single-user quotation
