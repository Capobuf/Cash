...
*Specifica canonica consolidata - v0.5*
...
L'MVP gestisce un solo codice ATECO e un solo coefficiente per profilo annuale. Se l'utente esercita attività appartenenti a gruppi con coefficienti diversi, la proiezione fiscale non è supportata e Cash non costruisce coefficienti medi; la pianificazione non fiscale resta utilizzabile.
...
**1.** Confermare la data proposta, selezionare o creare il Profilo economico annuale coerente e, se disponibile e necessario, selezionare il cliente da Fatture in Cloud. Cash copia azienda, identificativo cliente, ragione sociale e partita IVA; la scelta del cliente può essere rinviata, ma deve essere completata prima dell'esportazione.
...
| --- | --- |
| Profilo economico | Anno, fatturato obiettivo, Spese specifiche annue previste, parametri fiscali confermati, disponibilità lavorativa, festività locali e velocità media di trasferta. |
...
| Profilo fiscale | Anno, un solo codice ATECO, coefficiente maggiore di 0% e non superiore a 100%, aliquote tra 0% e 100%, massimale positivo e soglie coerenti obbligatori; profilo confermato prima delle proiezioni fiscali. Oltre la soglia di cessazione il preset forfettario non calcola indicatori fiscali. |
